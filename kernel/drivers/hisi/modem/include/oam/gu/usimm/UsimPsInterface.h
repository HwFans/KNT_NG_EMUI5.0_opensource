...
#define USIMM_PATHSTR_MAX_LEN_SUB_ONE           (USIMM_PATHSTR_MAX_LEN - 1)
...
enum USIMM_CMDTYPE_CNF_ENUM
{
    ...
    USIMM_HOTPLUGSTATUS_ND      = 110,

    USIMM_STKREFRESH_TYPE_IND   = 111,
...
typedef struct
{
    USIMM_VSIM_STATE_ENUM_UINT32        enVSIMState;
